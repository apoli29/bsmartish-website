...
export default function PropertyMobileSections({ property }) {
  ...
  return (
    <>
      ...
      <div className="block md:hidden order-1 px-8 pt-6 pb-8" style={{ backgroundColor: '#f8f8f8', borderBottom: '1px solid #e4e4e4' }}>
        <FadeIn delay={0}>
      ...
      {/* Mobile-only: full property details — after gallery and header, before overview (order-2, later in source) */}
